...
$hashed_password = password_hash($password, PASSWORD_DEFAULT);
    ...
    try{
        ...
        $sqlInsert ="INSERT INTO customers_1 (CustFirstName, CustLastName, CustUserName, Password, CustEmail, CustAddress, CustCity, CustProv, CustPostal, CustCountry, CustHomePhone, CustBusPhone, Join_Date) 
        VALUES (:CustFirstName, :CustLastName, :CustUserName, :Password, :CustEmail, :CustAddress, :CustCity, :CustProv, :CustPostal, :CustCountry, :CustHomePhone, :CustBusPhone, now())";
...
<div class="container text-align: center;">
     ...
     <h3>Cusstomer Registeration Form</h3>
     <?php
...
<div class="form-group">
  ...
  <div class="form-group">
    <label for="lastnameField">Username</label>
